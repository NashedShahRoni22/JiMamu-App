...
class ChooseOrderTypeScreenMyDeliveries extends StatefulWidget {
  const ChooseOrderTypeScreenMyDeliveries({super.key});

  @override
  State<ChooseOrderTypeScreenMyDeliveries> createState() =>
      _ChooseOrderTypeScreenMyDeliveriesState();
}

class _ChooseOrderTypeScreenMyDeliveriesState
    extends State<ChooseOrderTypeScreenMyDeliveries> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            InkWell(
              onTap: () {
                Get.to(() => const MyDeliveries(orderType: 'national'));
              },
              child: Container(
            ...
            InkWell(
              onTap: () {
                Get.to(() => const MyDeliveries(orderType: 'international'));
              },
              child: Container(
                padding: const EdgeInsets.all(18),
                decoration: BoxDecoration(
